...
public class CPService {
    ...
    //checks if the mobile no is present or not in db
    private final CPRepo cpRepo;

    @Autowired
    public CPService(CPRepo cpRepo) {
        this.cpRepo = cpRepo;
    }

    public boolean isMobileExists(String mobileNumber) {
        return cpRepo.existsByMobileNumber(mobileNumber);
    }
   ...
   public List<StatusDto> counterStatus()
   {
	...
	public String updateAvailability(long id, String status) {
		...
		if(counter.isPresent())
		{
		     ...
		     System.out.println(counterDetails.getStatus());
	...
	public ResponseEntity<?> getcategory() {
		 List<com.rs.www.model.Category> category= categoryrepo.findAll();
