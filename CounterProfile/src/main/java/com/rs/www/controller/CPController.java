...
public class CPController {
	...
	// checks the mobile number in the db
    ...
    public ResponseEntity<String> checkMobile(@RequestBody CPModel request) {
        boolean exists = cpService.isMobileExists(request.getMobileNumber());
